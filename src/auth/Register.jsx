    ...
    <div className="h-[100dvh] md:h-screen w-screen bg-white md:bg-[#F0F4F8] flex items-center justify-center p-0 md:p-8 font-sans selection:bg-blue-100 overflow-hidden">
      ...
      <div className="w-full max-w-[1200px] h-full md:max-h-[780px] bg-white rounded-none md:rounded-[3rem] shadow-none md:shadow-[0_30px_100px_rgba(0,0,0,0.06)] overflow-hidden flex flex-col md:flex-row border-0 md:border border-white relative">
        <div className="flex-1 px-4 py-6 md:py-8 md:px-14 flex flex-col justify-start md:justify-center relative overflow-y-auto custom-scrollbar">
          <a href="/" className="absolute top-3 left-2 md:top-14 md:left-14 p-3 md:p-2 z-10 md:z-auto text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded-full transition-all group" title="Back to Home"><ArrowLeft size={20} className="group-hover:-translate-x-1 transition-transform" /></a>
          ...
          <form className="space-y-4 max-w-md mx-auto w-full mb-auto md:mb-0" onSubmit={handleSignUp}>
            <div className="grid grid-cols-2 gap-3 md:gap-4">
               <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    ...
                    <input type="text" required value={formData.firstName} onChange={(e) => setFormData({...formData, firstName: e.target.value})} placeholder="Aditya" className="w-full bg-slate-50 border border-slate-100 rounded-xl pl-10 pr-3 md:px-12 py-3 text-sm text-slate-900 outline-none focus:border-blue-500 focus:bg-white transition-all shadow-sm" />
                  </div>
               </div>
               <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    <User size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-blue-600 transition-colors" />
                    <input type="text" required value={formData.lastName} onChange={(e) => setFormData({...formData, lastName: e.target.value})} placeholder="Pandey" className="w-full bg-slate-50 border border-slate-100 rounded-xl pl-10 pr-3 md:px-12 py-3 text-sm text-slate-900 outline-none focus:border-blue-500 focus:bg-white transition-all shadow-sm" />
                  </div>
               </div>
            </div>
            ...
            <p className="text-center text-xs text-slate-500 pb-2 md:pb-0">Already have an account? <a href="/login" className="inline-block md:inline py-2 md:py-0 text-blue-600 font-bold hover:underline">Log in</a></p>
          </form>
        </div>
