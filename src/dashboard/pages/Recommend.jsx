  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar">
        <div className="min-h-full flex flex-col items-center justify-center p-4 py-8 md:p-10 md:py-20 text-center space-y-6 md:space-y-8">
          <div className="w-20 h-20 md:w-24 md:h-24 bg-red-500/10 rounded-2xl md:rounded-[2rem] flex items-center justify-center text-red-500 shadow-[0_0_30px_rgba(239,68,68,0.2)]">
            <Heart size={48} className="fill-red-500 w-10 h-10 md:w-12 md:h-12" />
          </div>

          <div className="space-y-3 md:space-y-4 max-w-2xl">
            <h1 className="text-[30px] md:text-5xl font-black tracking-tighter leading-tight md:leading-tight">Spread the <span className="text-red-500">Architecture</span>.</h1>
            <p className="text-[15px] md:text-xl text-slate-500 font-medium leading-relaxed md:leading-relaxed">
          ...
          <div className={`w-full max-w-xl p-5 md:p-8 rounded-2xl md:rounded-[2.5rem] border border-white/10 bg-white/5 backdrop-blur-3xl shadow-2xl space-y-5 md:space-y-8 ${lc}`}>
            ...
            <div className="grid grid-cols-3 gap-2 md:gap-4">
              <button className={`flex flex-col items-center gap-2.5 md:gap-3 p-3 py-4 md:p-6 rounded-2xl bg-white/5 hover:bg-white/10 transition-all group ${lc}`}>
            ...
            <div className="p-4 md:p-6 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex items-center gap-3 md:gap-4 text-left">
